    ...
    class Cupid_Our_Staffs{
        ...
        function register_post_types() {
            ...
            register_post_type($post_tyte,
                array(
                    'label' => esc_attr__('Our Staffs', 'cupid'),
                    'description' => esc_attr__('Our Staffs Description', 'cupid'),
                    'labels' => array(
                        'name' => $name,
        ...
        {
            add_submenu_page('edit.php?post_type=our-staffs', 'Setting', 'Settings', 'edit_posts', wp_basename(__FILE__), array($this, 'initPageSettings'));
        }
